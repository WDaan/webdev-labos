...
<body>
    <div class="container">
        ...
        <h1 style="text-align:center; margin: 50px 0px 30px 0px;">Delete:</h1>
        <div class="form-group">
            <form method="POST">
                <label for="afkorting">ID:</label>
                <input class="form-control" type="number" min=1 Name="afkorting" id="afkorting" placeholder="afkorting" required>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $result = mysqli_query($link, "select * from afkortingen");
